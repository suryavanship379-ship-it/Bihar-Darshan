...
const staticDistrictDetails: Record<string, any> = {
  patna: {
    name: "Patna",
    ...
    topTouristName: "Golghar",
    topTouristDetails: "A massive, beehive-shaped granary built by Captain John Garstin in 1786. It offers a panoramic view of the city and the river Ganga from its summit.",
    seasonalVisits: [
    ...
    howToReachAir: "Patna is connected by Jay Prakash Narayan International Airport, which runs daily direct flights to major Indian cities like Delhi, Mumbai, Kolkata, and Bengaluru.",
    howToReachRail: "Patna Junction (PNBE) is a major railway hub of East India, connected to all parts of the country via express and superfast trains.",
    howToReachRoad: "Patna is well-connected by highways including NH 19, NH 20, and NH 31. Regular state bus services link Patna to neighboring states and cities."
  },
  gaya: {
    name: "Gaya",
    ...
    topTouristName: "Mahabodhi Temple Complex",
    topTouristDetails: "A UNESCO World Heritage site centered around the ancient temple and the holy Bodhi Tree where Buddha attained enlightenment.",
    seasonalVisits: [
    ...
    howToReachAir: "Gaya Airport is the second largest airport in Bihar, offering local flights and international seasonal charters to Southeast Asian countries.",
    howToReachRail: "Gaya Junction is a major station on the Grand Chord route, regular trains run from Delhi, Kolkata, Patna, and Ranchi.",
    howToReachRoad: "Gaya is connected to Patna via State Highway 1 and is located near national highway GT road (NH 19) linking Delhi and Kolkata."
  },
  nalanda: {
    name: "Nalanda",
    ...
    topTouristName: "Nalanda University Ruins",
    topTouristDetails: "A UNESCO World Heritage site consisting of ancient red-brick monasteries, temples, and lecture halls.",
    seasonalVisits: [
    ...
    howToReachAir: "The nearest airport is Jay Prakash Narayan International Airport in Patna (about 90 km away) or Gaya Airport (about 95 km away).",
    howToReachRail: "Rajgir Railway Station and Bihar Sharif Junction are the closest major railway points, with daily trains connecting Patna and Delhi.",
    howToReachRoad: "Nalanda is connected via NH 120 and state double-lane roads with Patna, Gaya, and other historical tourism sites."
  },
  vaishali: {
    name: "Vaishali",
    ...
    topTouristName: "Ashokan Pillar",
    topTouristDetails: "A perfectly preserved monolithic polished sandstone pillar crowned by a single lion facing northwards.",
    seasonalVisits: [
      ...
      { season: "Monsoon", months: "July to September", weather: "Moderate rains, landscape turns green", whyVisit: "Wetlands flourish — excellent for birdwatching around the tank" }
    ],
    whyInTouristList: [
    ...
    topAttractions: [
      ...
      { name: "Coronation Tank (Abhishek Pushkarini)", image: "/src/assets/vaishali.png", description: "The Abhishek Pushkarini is an ancient rectangular water pool where the elected officials of the Licchavi republic were ceremonially anointed before taking office. This makes it one of the world's oldest surviving symbols of democratic ceremonial practice. The tank's still, sacred waters are surrounded by well-maintained gardens and ancient brick embankments. Just steps away stands the magnificent Ashokan Pillar, forming a profound historical ensemble." },
      { name: "Vishwa Shanti Stupa", image: "/src/assets/vaishali.png", description: "The Vishwa Shanti Stupa, or World Peace Pagoda, is a gleaming white hemispherical dome built by the Japanese Buddhist organization Nipponzan Myohoji. It stands in a beautifully maintained park near the Ashokan Pillar. Four gilded statues of the Buddha representing birth, enlightenment, first sermon, and nirvana adorn its outer perimeter at the four cardinal points. The stupa is a popular site for walking meditation." }
    ],
    howToReachAir: "Patna Airport is the closest airport (approx 55 km away). Cabs and taxis are readily available for transport across the Ganga river.",
    howToReachRail: "Hajipur Junction is the closest main railway terminal (approx 25 km away), connected to all divisions of East Central Railway.",
    howToReachRoad: "Vaishali is linked to Hajipur and Patna by National Highway 19, crossing the historic Mahatma Gandhi Setu bridge."
  },
  bhagalpur: {
    name: "Bhagalpur",
    ...
    topTouristName: "Vikramshila University Ruins",
    topTouristDetails: "Rivaling Nalanda, this ancient university was the premier center for Vajrayana Buddhist tantric research.",
    seasonalVisits: [
    ...
    topAttractions: [
      ...
      { name: "Mandar Hill", image: "/src/assets/bihar-mountains.png", description: "Mandar Hill is a dramatic 750-foot granite monolith, traditionally used as a churning rod by gods and demons during the mythological Samudra Manthan as described in the Vishnu Purana. Ancient carvings of Varaha, Madhusudan, and other Vishnu avatars are etched directly into the bare granite rock face of the hill. A scenic climb up 700 rough-hewn steps rewards visitors with panoramic views." },
      { name: "Kupeshwar Nath Temple", image: "/src/assets/bihar-temple.png", description: "One of East Bihar's most ancient Shaivite pilgrimage shrines, this remarkable temple is named after a legendary bottomless well within its complex believed to connect to the underworld. The temple complex faces the Ganga river and is encircled by ancient terracotta plaques, Nandi statues, and eroded medieval stone carvings." },
      { name: "Ajgaibinath Temple (Sultanganj)", image: "/src/assets/bhagalpur-district.png", description: "This remarkable Shiva temple perches atop an ancient granite island rising dramatically from the middle of the Ganga at Sultanganj, accessible only by boat. During the auspicious Shravan month, this is the starting point of the Kanwar Yatra, during which millions of barefoot pilgrims walk 105 km to Deoghar carrying Ganga water." }
    ],
    howToReachAir: "Patna Airport is the nearest commercial airport (about 235 km away). Bagdogra Airport in West Bengal is also an alternative options.",
    howToReachRail: "Bhagalpur Junction (BGP) is a major railway station connecting North-Eastern regions with Patna, Kolkata, and Delhi.",
    howToReachRoad: "National Highway 80 crosses Bhagalpur directly, making it highly connected via local express buses and highway state networks."
  },
  muzaffarpur: {
    name: "Muzaffarpur",
    ...
    topTouristName: "Baba Garibnath Temple",
    topTouristDetails: "One of the most famous temples dedicated to Lord Shiva in North Bihar, which displays immense crowded festivals during Shravan.",
    seasonalVisits: [
  ...
  darbhanga: {
    ...
    topTouristName: "Darbhanga Royal Palaces",
    topTouristDetails: "A series of majestic palaces including the Lalit Narayan Mithila University campus and the surrounding Kameshwar Singh Fort.",
    seasonalVisits: [
...
const fallbackImages = [
  "/src/assets/bodh-gaya.png",
  "/src/assets/vaishali.png",
  "/src/assets/rajgir.png",
  "/src/assets/pawapuri.png",
  "/src/assets/bihar-monument.png",
  "/src/assets/bihar-heritage.png",
  "/src/assets/bihar-temple.png",
  "/src/assets/nalanda.png",
  "/src/assets/patna-district.png",
  "/src/assets/gaya-district.png",
  "/src/assets/bhagalpur-district.png",
  "/src/assets/muzaffarpur-district.png",
  "/src/assets/darbhanga-district.png",
];

const dedicatedImages: Record<string, string> = {
  Nalanda: "/src/assets/nalanda.png",
  Patna: "/src/assets/patna-district.png",
  Gaya: "/src/assets/gaya-district.png",
  Bhagalpur: "/src/assets/bhagalpur-district.png",
  Muzaffarpur: "/src/assets/muzaffarpur-district.png",
  Darbhanga: "/src/assets/darbhanga-district.png",
};

const getFallback = (index: number): string => {
  return fallbackImages[index % fallbackImages.length];
};

const generateFallbackDetails = (name: string): any => {
  ...
  return {
    ...
    topTouristName: `Ancient Temple of ${searchName}`,
    topTouristDetails: `A highly revered local religious site that boasts historical architecture and serves as a major gathering point for regional festivals.`,
    seasonalVisits: [
    ...
    topAttractions: [
      { name: `${searchName} Central Market`, image: "/src/assets/bihar-heritage.png", description: `The central marketplace of ${searchName} is a vibrant hub of local commerce and culture, where artisan crafters, spice traders, and street food vendors bring the district's identity alive.` },
      { name: "Historic Memorial Park", image: "/src/assets/bihar-monument.png", description: `The Historic Memorial Park commemorates the local heroes and important historical moments that shaped ${searchName}'s identity and contributed to the broader story of Bihar and India.` },
      { name: "River Ganga Ghat", image: "/src/assets/bihar-mountains.png", description: `The ghats along the river banks near ${searchName} offer a deeply peaceful encounter with Bihar's timeless riverine culture.` },
      { name: "Local Folk Center", image: "/src/assets/bihar-folk-dance.png", description: `The Local Folk Center is a dedicated cultural institution preserving and promoting the traditional arts, music, and crafts unique to ${searchName} and the broader Mithila region.` }
    ],
    howToReachAir: "Nearest air connectivity is available via Jay Prakash Narayan International Airport in Patna.",
    howToReachRail: `${searchName} Junction connects directly to the regional railway lines network of the East Central Railway division.`,
    howToReachRoad: `${searchName} is connected by regional asphalt state highways and links directly to adjacent district road hubs.`
  };
};
...
async function main() {
  ...
  // Delete existing districts to prevent duplicates
  await db.seasonRow.deleteMany({});
  await db.topAttraction.deleteMany({});
  await db.district.deleteMany({});

  console.log("Cleared old district information.");
  ...
  for (const name of districtNames) {
    ...
    // Get details
    const cleanKey = baseName.toLowerCase().replace(/\s+/g, "").trim();
    let details = staticDistrictDetails[cleanKey];
    if (!details) {
      // Check partial match
      const keyStr = Object.keys(staticDistrictDetails).find(k => cleanKey.includes(k) || k.includes(cleanKey));
      if (keyStr) {
        details = staticDistrictDetails[keyStr];
      }
    }

    if (!details) {
      details = generateFallbackDetails(name);
    }

    const { seasonalVisits, topAttractions, ...districtData } = details;
    ...
    await db.district.create({
      data: {
        ...
        introduction: districtData.introduction,
        richHistory: districtData.richHistory,
        whyInTouristList: districtData.whyInTouristList,
        topTouristName: districtData.topTouristName,
        topTouristDetails: districtData.topTouristDetails,
        howToReachAir: districtData.howToReachAir,
        howToReachRail: districtData.howToReachRail,
        howToReachRoad: districtData.howToReachRoad,
        seasonalVisits: {
          create: seasonalVisits.map((sv: any) => ({
            season: sv.season,
            months: sv.months,
            weather: sv.weather,
        ...
        topAttractions: {
          create: topAttractions.map((ta: any) => ({
            name: ta.name,
            image: ta.image,
...
main()
  .catch((e) => {
    console.error("Failed to seed districts:", e);
    process.exit(1);
  })
  .finally(async () => {
    await db.$disconnect();
