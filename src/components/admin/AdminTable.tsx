        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="bg-black/20 border border-white/10 rounded-xl pl-9 pr-4 py-2 text-sm text-white placeholder-white/30 focus:outline-none focus:border-[#D4A017]/50 focus:ring-1 focus:ring-[#D4A017]/20 w-full sm:w-64 transition-all"
            />
          </div>
          {onAdd && (
            <button
              onClick={onAdd}
              className="flex items-center gap-2 bg-[#D4A017] hover:bg-[#b8860b] text-black px-4 py-2 rounded-xl text-sm font-bold transition-colors shrink-0"
            >
              <Plus size={16} />
                    ...
                    <td className="px-6 py-4 text-right whitespace-nowrap">
                      <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        {onEdit && (
                          <button
                            onClick={() => onEdit(item)}
                            className="px-3 py-1.5 text-xs font-medium text-[#D4A017] hover:bg-[#D4A017]/10 rounded-lg transition-colors border border-transparent hover:border-[#D4A017]/20"
                          >
                            Edit
                          </button>
                        )}
