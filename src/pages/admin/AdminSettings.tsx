      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-[#D4A017]/50"
                />
              </div>
              <div className="flex flex-col gap-1.5">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                className="bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-[#D4A017]/50 min-h-[100px]"
              />
            </div>
        ...
        <div className="flex items-center justify-end gap-4 pt-4">
          ...
          <button 
            ...
            type="submit" 
            className="px-6 py-3 rounded-xl bg-[#D4A017] hover:bg-[#b8860b] text-black font-bold transition-all shadow-lg shadow-[#D4A017]/20"
          >
            Save Settings
          </button>
        </div>
